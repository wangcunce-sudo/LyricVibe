...
const createDict = {
  zh: {
    ...
    download: "下载 MP4",
    close: "关闭",
    modeSelectTitle: "选择创作方式",
    modeSelectDesc: "选择一种方式开始制作你的歌词字幕视频",
    modeVideoTitle: "📹 上传视频",
    modeVideoDesc: "上传你的视频和音频，AI 自动分析歌词情感，生成匹配的字幕样式。保留原始视频画面作为背景。",
    modeSceneTitle: "🎵 音频 + AI 背景",
    modeSceneDesc: "上传音频 + 用自然语言描述想要的背景，AI 为你生成循环动画底片。无需视频文件。",
    modeSceneTagAI: "AI 动画背景",
    modeSceneTagNL: "自然语言",
    backToModeSelect: "重新选择模式",
    sceneModeLabel: "音频 + AI 背景模式",
    sceneUploadTitle: "上传你的音频",
    sceneUploadDesc: "上传音乐文件，AI 将自动提取歌词并为你生成匹配的字幕",
    sceneDropAudio: "拖入音频文件",
    sceneClickHint: "或点击选择文件",
    sceneAudioFormats: "MP3, WAV, AAC, FLAC",
    sceneDescTitle: "描述你想要的背景",
    sceneDescHint: "用自然语言告诉 AI 你想要的循环动画背景效果",
    sceneDescPlaceholder: "例如：粉色泡泡在海底飘的梦幻背景...",
    sceneStartBtn: "开始创作",
    sceneStartHint: "AI 将自动转录歌词、分析情感、生成字幕样式和循环动画背景",
  },
  en: {
    back: "Back",
    appName: "LyricVibe",
    ...
    close: "Close",
    modeSelectTitle: "Choose a creation mode",
    modeSelectDesc: "Pick a way to start making your lyric subtitle video",
    modeVideoTitle: "📹 Upload Video",
    modeVideoDesc: "Upload your video and audio, AI analyzes lyric emotions and generates matching subtitle styles. Keeps your original video as background.",
    modeSceneTitle: "🎵 Audio + AI Background",
    modeSceneDesc: "Upload audio + describe your desired background in natural language, AI generates a looping animation. No video file needed.",
    modeSceneTagAI: "AI Animation",
    modeSceneTagNL: "Natural Language",
    backToModeSelect: "Change mode",
    sceneModeLabel: "Audio + AI Background Mode",
    sceneUploadTitle: "Upload your audio",
    sceneUploadDesc: "Upload a music file, AI will extract lyrics and generate matching subtitles",
    sceneDropAudio: "Drop your audio here",
    sceneClickHint: "or click to browse",
    sceneAudioFormats: "MP3, WAV, AAC, FLAC",
    sceneDescTitle: "Describe your background",
    sceneDescHint: "Tell AI what looping animation background you want in natural language",
    sceneDescPlaceholder: "e.g. Pink bubbles floating in an underwater dreamscape...",
    sceneStartBtn: "Start Creating",
    sceneStartHint: "AI will transcribe lyrics, analyze emotions, generate subtitle styles and looping animation background",
  },
};
